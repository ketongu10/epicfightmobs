...
public class FatalDrawSkill extends SelectiveAttackSkill
{
	...
	{
		super(SkillSlot.WEAPON_SPECIAL_ATTACK, 30.0F, skillName, 40.0F, (executer)->{
	...
	{
		boolean isSheathed = executer.getSkill(SkillSlot.WEAPON_GIMMICK).getDataManager().getDataValue(KatanaPassive.SHEATH);
