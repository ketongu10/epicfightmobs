...
public class DodgeSkill extends Skill {
	...
	public DodgeSkill(SkillSlot index, float cooldown, int maxStack, String skillName, float chargeIn, StaticAnimation... animation) {
		super(index, cooldown, 0, maxStack, true, skillName, chargeIn);
		this.animations = animation;
	}
	...
	public void decreaseStamina(ServerPlayerData executer) {
		super.decreaseStamina(executer);
	}
}