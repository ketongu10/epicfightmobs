...
public class PlayerEventListener {
    ...
    public static class EventType<T extends PlayerEvent<?>> {
        public static final EventType<ActionEvent> ACTION_EVENT = new EventType<>(Side.SERVER);
        ...
        public static final EventType<DealtDamageEvent<ServerPlayerData>> DEALT_DAMAGE_POST_EVENT = new EventType<>(Side.SERVER);
        public static final EventType<TakeDamageEvent> TAKE_DAMAGE_EVENT = new EventType<>(Side.SERVER);
        public static final EventType<AttackEndEvent> ATTACK_ANIMATION_END_EVENT = new EventType<>(Side.SERVER);
        public static final EventType<HitEvent> HIT_EVENT = new EventType<>(Side.SERVER);
        public static final EventType<BasicAttackEvent> BASIC_ATTACK_EVENT = new EventType<>(Side.SERVER);
        public static final EventType<MovementInputEvent> MOVEMENT_INPUT_EVENT = new EventType<>(Side.CLIENT);
        public static final EventType<RightClickItemEvent<ClientPlayerData>> CLIENT_ITEM_USE_EVENT = new EventType<>(Side.CLIENT);
        public static final EventType<RightClickItemEvent<ServerPlayerData>> SERVER_ITEM_USE_EVENT = new EventType<>(Side.SERVER);
        public static final EventType<ItemUseEndEvent> SERVER_ITEM_STOP_EVENT = new EventType<>(Side.SERVER);
