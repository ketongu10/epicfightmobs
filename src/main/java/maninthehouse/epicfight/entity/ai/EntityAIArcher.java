...
public class EntityAIArcher<T extends EntityCreature & IRangedAttackMob> extends EntityAIBase
{
    ...
    {
        return !this.entity.getHeldItemMainhand().isEmpty() && this.entity.getHeldItemMainhand().getItem() == Items.BOW || !this.entity.getHeldItemOffhand().isEmpty() && this.entity.getHeldItemOffhand().getItem() == Items.BOW;
    }
    ...
    public void updateTask()
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            else if (--this.attackTime <= 0 && this.seeTime >= -60)
            {
                ...
                if (!this.entity.getHeldItemMainhand().isEmpty() && this.entity.getHeldItemMainhand().getItem() == Items.BOW) {
