...
public class EntityAIActionPattern extends EntityAIBase
{
    ...
    protected final List<ActionAnimation> pattern;
    protected final boolean affectHorizon;

    protected int patternIndex;

    public EntityAIActionPattern(MobData mobdata, EntityCreature attacker, double minDist, double maxDIst, boolean affectHorizon, List<ActionAnimation> pattern)
    {
    ...
    public void updateTask()
    {
        ...
        {
            ActionAnimation att = pattern.get(patternIndex++);
            this.patternIndex %= pattern.size();
