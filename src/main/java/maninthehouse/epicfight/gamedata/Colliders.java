...
public class Colliders {
	...
	public static Collider fatal_draw = new ColliderOBB(1.75F, 0.7F, 1.5F, 0F, 1.0F, -1.5F);//1.5F=posZ
	public static Collider huge_draw = new ColliderOBB(1.25F, 0.5F, 1.0F, 0F, 1.0F, -1.5F);//1.5F=posZ
	...
	public static Collider longsword = new ColliderOBB( 0.4F, 0.4F, 0.8F, 0F, 0F, -0.75F);

	public static Collider dualDaggerDash = new ColliderOBB(0.8F, 0.5F, 1.0F, 0.0F, 1.0F, -0.6F);

	public static Collider dualSwordAirslash = new ColliderOBB(0.8F, 0.4F, 1.0F, 0F, 0.5F, -0.5F);
	public static Collider dualDaggerAirslash = new ColliderOBB(0.8F, 0.4F, 0.75F, 0F, 0.5F, -0.5F);
	public static Collider narrowFront = new ColliderOBB(0.4F, 0.4F, 0.5F, 0F, 1.0F, -0.85F);
	public static Collider bladeRush = new ColliderOBB(0.8F, 0.5F, 1.9F, 0.0F, 1.0F, -1.2F);
