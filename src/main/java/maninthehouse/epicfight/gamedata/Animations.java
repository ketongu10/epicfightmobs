...
public final class Animations {
	...
	public static StaticAnimation BIPED_TACHI_HELD;

	public static StaticAnimation MAGIC_DASH_STAFF;
	public static StaticAnimation MAGIC_DASH_WAND;
	public static StaticAnimation MAGIC_SWING;
	public static StaticAnimation SUMMONNING_WAND;
	public static StaticAnimation SUMMONNING_STAFF;
	...
	public static StaticAnimation BIPED_KICK;


	public static StaticAnimation HUGE_AXE_AUTO1;
	public static StaticAnimation HUGE_GREATSWORD_AUTO_2;
	public static StaticAnimation HUGE_GREATSWORD_AUTO_1;
	public static StaticAnimation HUGE_AXE_AUTO2;
	public static StaticAnimation HUGE_SWORD_DUAL_AUTO_2;
	public static StaticAnimation HUGE_ZOMBIE_ATTACK3;
	public static StaticAnimation HUGE_KNEE;
	public static StaticAnimation HUGE_FIST_AUTO2;
	public static StaticAnimation HUGE_LETHAL_SLICING_ONCE;
	...
	public static void registerAnimations(Side dist) {
		...
		HUGE_AXE_AUTO1 = new AAAnimation(1800, 0.16F, 0.25F, 0.35F, 0.7F, 1.0F, Colliders.huge_draw, "", "biped/combat/axe_auto1.dae")
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_BIG).addProperty(AnimationProperty.HIT_SOUND, Sounds.EVISCERATE).bindFull(biped); //11213
		HUGE_AXE_AUTO2 = new AAAnimation(1801, 0.16F, 0.25F, 0.35F, 0.85F, 1.0F, Colliders.huge_draw, "", "biped/combat/axe_auto2.dae")
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_BIG).addProperty(AnimationProperty.HIT_SOUND, Sounds.EVISCERATE).bindFull(biped);//111213
		HUGE_GREATSWORD_AUTO_1 = new AAAnimation(1802, 0.21F, 0.4F, 0.6F, 0.9F, 0.8F, Colliders.huge_draw, "", "biped/combat/greatsword_auto1.dae")
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_BIG).addProperty(AnimationProperty.HIT_SOUND, Sounds.EVISCERATE).bindFull(biped);//111213
		HUGE_GREATSWORD_AUTO_2 = new AAAnimation(1803, 0.2F, 0.55F, 0.75F, 1.05F, 0.8F, Colliders.huge_draw, "", "biped/combat/greatsword_auto2.dae")
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_BIG).addProperty(AnimationProperty.HIT_SOUND, Sounds.EVISCERATE).bindFull(biped);//111213

		HUGE_SWORD_DUAL_AUTO_2 = new AAAnimation(1804, 0.13F, 0.0F, 0.1F, 0.1F, 1.6F, EnumHand.OFF_HAND, Colliders.huge_draw, "", "biped/combat/dual_auto2.dae")
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_BIG).addProperty(AnimationProperty.HIT_SOUND, Sounds.EVISCERATE).bindFull(biped);//111313
		HUGE_ZOMBIE_ATTACK3 = new TargetTraceAnimation(1805, 0.1F, 0.5F, 0.5F, 0.6F, 1.15F, false, Colliders.huge_draw, "", "zombie/attack3.dae")
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_BIG).bindFull(biped);//113
		HUGE_KNEE = new TargetTraceAnimation(1806, 0.16F, 0.25F, 0.25F, 0.31F, 1.0F, false, Colliders.huge_draw, "", "enderman/knee.dae") //12
				.addProperty(AnimationProperty.STUN_TYPE, StunType.LONG).bindFull(enderman);
		HUGE_FIST_AUTO2 = new AAAnimation(1807, 0.08F, 0F, 0.1F, 0.15F, 4F, Colliders.huge_draw, "", "biped/combat/fist_auto2.dae").bindFull(biped);//111213

		HUGE_LETHAL_SLICING_ONCE = new SpecialAttackAnimation(1808, 0.016F, 0.0F, 0.0F, 0.1F, 0.6F, false, Colliders.huge_draw, "", "biped/skill/lethal_slicing_once.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true)
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_BIG)
				.addProperty(AnimationProperty.HIT_SOUND, Sounds.EVISCERATE)
				.addProperty(AnimationProperty.ARMOR_NEGATION, 40.0F)
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);


		BIPED_HOLD_LONGSWORD = new AimingAnimation(6005, 0.16F, false, "biped/living/hold_longsword.dae", "biped/living/hold_longsword.dae", "biped/living/hold_longsword.dae").bindOnlyClient(biped, dist);
		BIPED_TACHI_HELD = new AimingAnimation(6008,0.15F, true, "biped/living/hold_tachi.dae","biped/living/hold_tachi.dae","biped/living/hold_tachi.dae").bindOnlyClient(biped, dist);
		MAGIC_SWING = new StaticAnimation(6005, 0.087F, false, "biped/combat/sword_auto4.dae").bindFull(biped);
		MAGIC_DASH_WAND = new AimingAnimation(6010, 0.01F, false, "biped/combat/greatsword_airslash.dae").bindOnlyClient(biped, dist);//javelin_throw_mid.dae - norm

		MAGIC_DASH_STAFF = new AimingAnimation(6009, 0.16F, false, "biped/living/hold_longsword.dae").bindOnlyClient(biped, dist);
		SUMMONNING_WAND = new AimingAnimation(6011, 0.16F, true, "illager/spellcast.dae").bindOnlyClient(biped, dist);
		SUMMONNING_STAFF = new AimingAnimation(6012, 0.16F, false, "biped/skill/guard_greatsword_hit.dae").bindOnlyClient(biped, dist);

		SPEAR_GUARD = new AimingAnimation(6031,0.25F,false, "biped/skill/guard_spear.dae").bindOnlyClient(biped, dist);
		SWORD_GUARD = new AimingAnimation(6032,0.25F, false, "biped/skill/guard_sword.dae").bindOnlyClient(biped, dist);
		SWORD_DUAL_GUARD = new AimingAnimation(6033,0.25F,false, "biped/skill/guard_dualsword.dae").bindOnlyClient(biped, dist);
		GREATSWORD_GUARD = new AimingAnimation(6034,0.25F, false, "biped/skill/guard_greatsword.dae").bindOnlyClient(biped, dist);
		KATANA_GUARD = new AimingAnimation(6035,0.25F, false, "biped/skill/guard_katana.dae").bindOnlyClient(biped, dist);
		LONGSWORD_GUARD = new AimingAnimation(6036,0.25F, false, "biped/skill/guard_longsword.dae").bindOnlyClient(biped, dist);


		SWORD_AIR_SLASH = new AAAnimation(6018, 0.1F, 0.15F, 0.26F, 0.5F, 1.6F, null, "111213", "biped/combat/sword_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		SWORD_DUAL_AIR_SLASH = new AAAnimation(6019, 0.1F, 0.15F, 0.26F, 0.5F, 1.6F, Colliders.dualSwordAirslash, "3", "biped/combat/sword_dual_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 2.0F)
				.bindFull(biped);
		KATANA_AIR_SLASH = new AAAnimation(6020, 0.1F, 0.05F, 0.16F, 0.3F, 1.6F, null, "111213", "biped/combat/katana_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		KATANA_SHEATH_AIR_SLASH = new AAAnimation(6021, 0.1F, 0.1F, 0.16F, 0.3F, 1.6F, null, "111213", "biped/combat/katana_sheath_airslash.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true)
		...
		SPEAR_ONEHAND_AIR_SLASH = new AAAnimation(6022, 0.1F, 0.15F, 0.26F, 0.4F, 1.6F, null, "111213", "biped/combat/spear_onehand_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		SPEAR_TWOHAND_AIR_SLASH = new AAAnimation(6023,0.1F, 0.25F, 0.36F, 0.6F, 1.6F, null, "111213", "biped/combat/spear_twohand_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		GREATSWORD_AIR_SLASH = new AAAnimation(6024, 0.1F, 0.5F, 0.55F, 0.71F, 0.8F, null, "111213", "biped/combat/greatsword_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		FIST_AIR_SLASH = new AAAnimation(6025, 0.1F, 0.15F, 0.26F, 0.4F, 1.6F, null, "111213", "biped/combat/fist_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		DAGGER_AIR_SLASH = new AAAnimation(6026, 0.1F, 0.15F, 0.26F, 0.45F, 1.6F, null, "111213", "biped/combat/dagger_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		DAGGER_DUAL_AIR_SLASH = new AAAnimation(6027, 0.1F, 0.15F, 0.26F, 0.4F, 1.6F, Colliders.dualDaggerAirslash, "3", "biped/combat/sword_dual_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		AXE_AIRSLASH = new AAAnimation(6028,0.1F, 0.3F, 0.4F, 0.65F, 1.6F, null, "111213", "biped/combat/axe_airslash.dae")
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 1.5F)
				.bindFull(biped);
		LONGSWORD_AIR_SLASH = new AAAnimation(6006, 0.1F, 0.3F, 0.41F, 0.5F, 1.6F, null, "111213", "biped/combat/longsword_airslash.dae").bindFull(biped);
		...
		BIPED_CLIMBING = new StaticAnimation(42, true, "biped/living/climb.dae").bindOnlyClient(biped, dist);
		BIPED_SLEEPING = new StaticAnimation(42, true, "biped/living/sleep.dae").bindOnlyClient(biped, dist);
		...
		BIPED_STEP_BACKWARD = new DodgingAnimation(1995, 0.09F, false, "biped/skill/step_backward.dae", 0.6F, 1.8F).bindFull(biped);
		...
		LONGSWORD_AUTO_1 = new AAAnimation(2031, 0.1F, 0.2F, 0.3F, 0.45F, 1.6F, null, "111213", "biped/combat/longsword_auto1.dae").bindFull(biped);
		LONGSWORD_AUTO_2 = new AAAnimation(2032,0.15F, 0.1F, 0.21F, 0.45F, 1.6F, null, "111213", "biped/combat/longsword_auto2.dae").bindFull(biped);
		LONGSWORD_AUTO_3 = new AAAnimation(2033,0.15F, 0.05F, 0.16F, 0.8F, 1.6F, null, "111213", "biped/combat/longsword_auto3.dae").bindFull(biped);
		LONGSWORD_DASH = new AADashAnimation(2034,0.15F, 0.1F, 0.3F, 0.5F, 0.7F, null, "111213", "biped/combat/longsword_dash.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true).bindFull(biped);

		DAGGER_AUTO_1 = new AAAnimation(2035,0.08F, 0.05F, 0.15F, 0.2F, 1.6F, null,"111213", "biped/combat/dagger_auto1.dae").bindFull(biped);
		DAGGER_AUTO_2 = new AAAnimation(2036,0.08F, 0.0F, 0.1F, 0.2F, 1.6F,null, "111213", "biped/combat/dagger_auto2.dae").bindFull(biped);
		DAGGER_AUTO_3 = new AAAnimation(2037, 0.08F, 0.15F, 0.26F, 0.5F,1.6F, null, "111213", "biped/combat/dagger_auto3.dae").bindFull(biped);
		DAGGER_DUAL_AUTO_1 = new AAAnimation(2038, 0.08F, 0.05F, 0.16F, 0.25F,1.6F, null, "111213", "biped/combat/dagger_dual_auto1.dae").bindFull(biped);
		DAGGER_DUAL_AUTO_2 = new AAAnimation(2039, 0.08F, 0.0F, 0.11F, 0.16F, 1.6F, EnumHand.OFF_HAND, null, "111313", "biped/combat/dagger_dual_auto2.dae").bindFull(biped);
		DAGGER_DUAL_AUTO_3 = new AAAnimation(2040, 0.08F, 0.0F, 0.11F, 0.2F, 1.6F,null, "111213", "biped/combat/dagger_dual_auto3.dae").bindFull(biped);
		DAGGER_DUAL_AUTO_4 = new AAAnimation(2041, 0.13F, 0.1F, 0.21F, 0.4F, 1.6F, Colliders.dualDaggerDash, "111213","biped/combat/dagger_dual_auto4.dae").bindFull(biped);
		DAGGER_DUAL_DASH = new AADashAnimation(2042,0.1F, 0.1F, 0.25F, 0.3F, 0.65F, Colliders.dualDaggerDash, "", "biped/combat/dagger_dual_dash.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true).bindFull(biped);

		TACHI_DASH = new AADashAnimation(2043,0.15F, 0.1F, 0.2F, 0.45F, 0.7F, null, "111213", "biped/combat/tachi_dash.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true).bindFull(biped);
		...
		SWORD_GUARD_HIT = new HitAnimation(	2994,0.05F,  "biped/skill/guard_sword_hit.dae").bindFull(biped);
		SWORD_DUAL_GUARD_HIT = new HitAnimation(2995, 0.05F,  "biped/skill/guard_dualsword_hit.dae").bindFull(biped);
		LONGSWORD_GUARD_HIT = new HitAnimation(2996,0.05F,  "biped/skill/guard_longsword_hit.dae").bindFull(biped);
		SPEAR_GUARD_HIT = new HitAnimation(2997, 0.05F,  "biped/skill/guard_spear_hit.dae").bindFull(biped);
		GREATSWORD_GUARD_HIT = new HitAnimation(2998, 0.05F,  "biped/skill/guard_greatsword_hit.dae").bindFull(biped);
		KATANA_GUARD_HIT = new HitAnimation(2999, 0.05F,  "biped/skill/guard_katana_hit.dae").bindFull(biped);


		BIPED_KICK = new TargetTraceAnimation(3018, 0.16F, 0.66F, 0.7F, 0.81F, 1.6F, false, Colliders.fatal_draw, "12", "enderman/rush_kick.dae")
				.addProperty(AnimationProperty.STUN_TYPE, StunType.SHORT).bindFull(enderman);
		...
		LETHAL_SLICING = new SpecialAttackAnimation(5006,0.15F, 0.0F, 0.0F, 0.11F, 0.38F, false, Colliders.narrowFront, "", "biped/skill/lethal_slicing_start.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true)
				.addProperty(AnimationProperty.HIT_SOUND, Sounds.BLUNT_HIT)
				.bindFull(biped);
		...
		LETHAL_SLICING_TWICE = new SpecialAttackAnimation(5008, 0.016F, false, "biped/skill/lethal_slicing_twice.dae",
				...
				.addProperty(AnimationProperty.SWING_SOUND, Sounds.WHOOSH_SHARP)
				.addProperty(AnimationProperty.ARMOR_NEGATION, 40.0F)
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 0.7F)
				.bindFull(biped);

		RELENTLESS_COMBO = new SpecialAttackAnimation(5009, 0.05F, false, "biped/skill/relentless_combo.dae",
				new Phase(0.016F, 0.016F, 0.066F, 0.133F, EnumHand.OFF_HAND, "", Colliders.narrowFront), new Phase(0.133F, 0.133F, 0.183F, 0.25F, "", Colliders.narrowFront),
				new Phase(0.25F, 0.25F, 0.3F, 0.366F, EnumHand.OFF_HAND, "", Colliders.narrowFront), new Phase(0.366F, 0.366F, 0.416F, 0.483F, "", Colliders.narrowFront),
				new Phase(0.483F, 0.483F, 0.533F, 0.6F, EnumHand.OFF_HAND, "", Colliders.narrowFront), new Phase(0.6F, 0.6F, 0.65F, 0.716F, "", Colliders.narrowFront),
				new Phase(0.716F, 0.716F, 0.766F, 0.833F, EnumHand.OFF_HAND, "", Colliders.narrowFront), new Phase(0.833F, 0.833F, 0.883F, 1.1F, "", Colliders.narrowFront))
				.bindFull(biped);
		...
		EVISCERATE_SECOND = new SpecialAttackAnimation(5011,0.15F, 0.0F, 0.0F, 0.0F, 0.4F, true, null, "111213", "biped/skill/eviscerate_second.dae")
				.addProperty(AnimationProperty.LOCK_ROTATION, true)
				.addProperty(AnimationProperty.STUN_TYPE, StunType.LONG)
				.addProperty(AnimationProperty.HIT_SOUND, Sounds.EVISCERATE)
				.addProperty(AnimationProperty.DAMAGE_MULTIPLIER, 2.0F)
				.addProperty(AnimationProperty.ARMOR_NEGATION, 100.0F)
				.bindFull(biped);

		BLADE_RUSH_FIRST = new SpecialAttackAnimation(5012,0.1F, 0.0F, 0.0F, 0.06F, 0.3F, true, Colliders.bladeRush, "", "biped/skill/blade_rush_first.dae").bindFull(biped);
		BLADE_RUSH_SECOND = new SpecialAttackAnimation(5013,0.1F, 0.0F, 0.0F, 0.06F, 0.3F, true, Colliders.bladeRush, "", "biped/skill/blade_rush_second.dae").bindFull(biped);
		BLADE_RUSH_THIRD = new SpecialAttackAnimation(5014,0.1F, 0.0F, 0.0F, 0.06F, 0.3F, true, Colliders.bladeRush, "", "biped/skill/blade_rush_third.dae").bindFull(biped);
		BLADE_RUSH_FINISHER = new SpecialAttackAnimation(5015,0.15F, 0.0F, 0.1F, 0.16F, 0.65F, true, Colliders.bladeRush, "", "biped/skill/blade_rush_finisher.dae").bindFull(biped);
