...
public class SpearItem extends WeaponItem {
	...
	public void setStats() {
    	...
    	capability.addStyleCombo(WieldStyle.ONE_HAND, Animations.SPEAR_ONEHAND_AUTO, Animations.SPEAR_ONEHAND_AIR_SLASH, Animations.SPEAR_DASH);
    	capability.addStyleCombo(WieldStyle.TWO_HAND, Animations.SPEAR_TWOHAND_AUTO_1, Animations.SPEAR_TWOHAND_AUTO_2, Animations.SPEAR_TWOHAND_AIR_SLASH, Animations.SPEAR_DASH);
		...
		capability.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.SPEAR_GUARD);
    }
