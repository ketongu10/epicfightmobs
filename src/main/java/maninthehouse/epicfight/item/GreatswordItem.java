...
public class GreatswordItem extends WeaponItem {
	...
	public void setWeaponCapability() {
    	...
    	capability.addStyleCombo(WieldStyle.TWO_HAND, Animations.GREATSWORD_AUTO_1, Animations.GREATSWORD_AUTO_2, Animations.GREATSWORD_AIR_SLASH,Animations.GREATSWORD_DASH);
		...
		capability.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.GREATSWORD_GUARD);
    }
