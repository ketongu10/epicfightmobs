...
public class EvilWizardData<T extends EntityEvilWizard> extends BipedMobData<T> {
    int isCast;

    public EvilWizardData() {
    ...
    public void onEntityJoinWorld(T entityIn) {
        ...
        if (entityIn instanceof IArmourClassWizard) {
    ...
    protected void initAttributes() {
        ...
        this.orgEntity.getAttributeMap().getAttributeInstance(ModAttributes.MAX_STUN_ARMOR).setBaseValue(10.0F);
