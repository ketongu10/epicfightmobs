...
public class SwordCapability extends MaterialItemCapability {
	...
	public SwordCapability(Item item) {
		...
		if (swordAttackMotion == null) {
			...
			swordAttackMotion.add(Animations.SWORD_AIR_SLASH);
			...
			dualSwordAttackMotion.add(Animations.SWORD_DUAL_AIR_SLASH);
			dualSwordAttackMotion.add(Animations.SWORD_DUAL_DASH);
		}
		this.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.SWORD_GUARD);
	}
