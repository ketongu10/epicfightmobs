...
public class ConfigurationCapability {
	...
	public static enum WeaponType {
		AXE(()->{
			...
			cap.addStyleCombo(WieldStyle.ONE_HAND, Animations.AXE_AUTO1, Animations.AXE_AUTO2, Animations.AXE_AIRSLASH, Animations.AXE_DASH);
			...
			cap.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.SWORD_GUARD);
			return cap;
		}),
		FIST(()->{
			...
			cap.addStyleCombo(WieldStyle.ONE_HAND, Animations.FIST_AUTO_1, Animations.FIST_AUTO_2, Animations.FIST_AUTO_3, Animations.FIST_AIR_SLASH, Animations.FIST_DASH);
			return cap;
		}),
		HOE(()->{
		...
		SWORD(()->{
			...
			cap.addStyleCombo(WieldStyle.ONE_HAND, Animations.SWORD_AUTO_1, Animations.SWORD_AUTO_2, Animations.SWORD_AUTO_3, Animations.SWORD_AIR_SLASH,Animations.SWORD_DASH);
			cap.addStyleCombo(WieldStyle.TWO_HAND, Animations.SWORD_DUAL_AUTO_1, Animations.SWORD_DUAL_AUTO_2, Animations.SWORD_DUAL_AUTO_3, Animations.SWORD_DUAL_AIR_SLASH, Animations.SWORD_DUAL_DASH);
			cap.addStyleCombo(WieldStyle.MOUNT, Animations.SWORD_MOUNT_ATTACK);
			...
			cap.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.SWORD_GUARD);/**AAAAAA DUAL!!!!! AAAAAAA**/
			return cap;
		}),
		SPEAR(()->{
			...
			cap.addStyleCombo(WieldStyle.ONE_HAND, Animations.SPEAR_ONEHAND_AUTO, Animations.SPEAR_ONEHAND_AIR_SLASH, Animations.SPEAR_DASH);
			cap.addStyleCombo(WieldStyle.TWO_HAND, Animations.SPEAR_TWOHAND_AUTO_1, Animations.SPEAR_TWOHAND_AUTO_2, Animations.SPEAR_TWOHAND_AIR_SLASH, Animations.SPEAR_DASH);
			...
			cap.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.SPEAR_GUARD);
			return cap;
		}),
		GREATSWORD(()->{
			...
			cap.addStyleCombo(WieldStyle.TWO_HAND, Animations.GREATSWORD_AUTO_1, Animations.GREATSWORD_AUTO_2, Animations.GREATSWORD_AIR_SLASH,Animations.GREATSWORD_DASH);
			...
			cap.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.GREATSWORD_GUARD);
			return cap;
		}),
		LONGSWORD(()->{
			ModWeaponCapability cap = new ModWeaponCapability(WeaponCategory.LONGSWORD, (playerdata)-> WieldStyle.TWO_HAND,
					null, Sounds.WHOOSH, Sounds.BLADE_HIT, Colliders.longsword, HandProperty.TWO_HANDED);
			cap.addStyleCombo(WieldStyle.TWO_HAND, Animations.LONGSWORD_AUTO_1,  Animations.LONGSWORD_AUTO_2, Animations.LONGSWORD_AUTO_3, Animations.LONGSWORD_AIR_SLASH, Animations.LONGSWORD_DASH);
			cap.addStyleCombo(CapabilityItem.WieldStyle.MOUNT, Animations.SWORD_MOUNT_ATTACK);
			cap.addStyleSpecialAttack(WieldStyle.TWO_HAND, Skills.LETHAL_SLICING);
			cap.addLivingMotionChanger(LivingMotion.IDLE, Animations.BIPED_TACHI_HELD);
			cap.addLivingMotionChanger(LivingMotion.TACHI, Animations.BIPED_TACHI_HELD);
			cap.addLivingMotionChanger(LivingMotion.RUNNING, Animations.BIPED_RUN_HELDING_WEAPON);
			cap.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.LONGSWORD_GUARD);
			//cap.addStyleSpecialAttack(WieldStyle.LIECHTENHAUER, Skills.LIECHTENHAUER);
			return cap;
		}),
		KATANA(()->{
			...
			cap.addStyleCombo(WieldStyle.TWO_HAND, Animations.KATANA_AUTO_1, Animations.KATANA_AUTO_2, Animations.KATANA_AUTO_3, Animations.KATANA_AIR_SLASH, Animations.KATANA_SHEATHING_DASH);
			cap.addStyleCombo(WieldStyle.MOUNT, Animations.SWORD_MOUNT_ATTACK);
			...
			cap.addLivingMotionChanger(LivingMotion.BLOCKING, Animations.KATANA_GUARD);
			return cap;
		}),
		KNUCKLE (()-> {
			ModWeaponCapability cap = new ModWeaponCapability(CapabilityItem.WeaponCategory.FIST, (playerdata) -> {
				CapabilityItem item = playerdata.getHeldItemCapability(EnumHand.OFF_HAND);
			...
			cap.addStyleCombo(CapabilityItem.WieldStyle.ONE_HAND, Animations.FIST_AUTO_1, Animations.FIST_AUTO_2, Animations.FIST_AUTO_3, Animations.FIST_AIR_SLASH, Animations.FIST_DASH);
			cap.addStyleCombo(CapabilityItem.WieldStyle.TWO_HAND, Animations.FIST_AUTO_1, Animations.FIST_AUTO_2, Animations.FIST_AUTO_3, Animations.FIST_AIR_SLASH, Animations.FIST_DASH);
			cap.addStyleSpecialAttack(CapabilityItem.WieldStyle.TWO_HAND, Skills.RELENTLESS_COMBO);
			cap.addStyleSpecialAttack(CapabilityItem.WieldStyle.ONE_HAND, null);
			return cap;
		}),
		DAGGER(()->{
			ModWeaponCapability cap = new ModWeaponCapability(WeaponCategory.DAGGER, (playerdata)->{
				CapabilityItem item = playerdata.getHeldItemCapability(EnumHand.OFF_HAND);
				if(item != null && item.getWeaponCategory() == WeaponCategory.DAGGER) {
					return WieldStyle.TWO_HAND;
				} else {
					return WieldStyle.ONE_HAND;
				}
			}, null, Sounds.WHOOSH, Sounds.BLADE_HIT, Colliders.sword, HandProperty.GENERAL);
			cap.addStyleCombo(WieldStyle.ONE_HAND, Animations.DAGGER_AUTO_1, Animations.DAGGER_AUTO_2, Animations.DAGGER_AUTO_3, Animations.DAGGER_AIR_SLASH, Animations.KATANA_SHEATHING_DASH);
			cap.addStyleCombo(WieldStyle.TWO_HAND, Animations.DAGGER_DUAL_AUTO_1, Animations.DAGGER_DUAL_AUTO_2, Animations.DAGGER_DUAL_AUTO_3, Animations.DAGGER_DUAL_AUTO_4, Animations.DAGGER_DUAL_AIR_SLASH, Animations.DAGGER_DUAL_DASH);
			cap.addStyleCombo(WieldStyle.MOUNT, Animations.SWORD_MOUNT_ATTACK);
			cap.addStyleSpecialAttack(WieldStyle.ONE_HAND, Skills.EVISCERATE);
			cap.addStyleSpecialAttack(WieldStyle.TWO_HAND, Skills.EVISCERATE);
			return cap;
		});
		...
		static {
			...
			searchByName.put("LONGSWORD", WeaponType.LONGSWORD);
			searchByName.put("KATANA", WeaponType.KATANA);
			searchByName.put("DAGGER", WeaponType.DAGGER);
			searchByName.put("KNUCKLE", WeaponType.KNUCKLE);
		}
