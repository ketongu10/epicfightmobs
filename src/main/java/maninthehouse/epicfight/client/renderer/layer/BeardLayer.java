...
public class BeardLayer <E extends EntityLivingBase, T extends LivingData<E>> extends Layer<E, T> {
    ...
    public BeardLayer(EntityEquipmentSlot slotType) {
        this.slot = slotType;
    }

    @Override
    public void renderLayer(T entitydata, E entityliving, VisibleMatrix4f[] poses, float partialTicks) {
        ItemStack stack = new ItemStack(ModItems.WIZARD_BEARD);
    ...
    private ClientModel getArmorModel(E entityliving, ItemArmor armorItem, ItemStack stack) {
        ...
        if (ARMOR_MODEL_MAP.containsKey(registryName)) {
            ...
            } else if (armorItem instanceof ItemWizardArmour && slot != EntityEquipmentSlot.LEGS) {
