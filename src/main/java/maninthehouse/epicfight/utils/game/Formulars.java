...
public class Formulars {
	...
	public static double DPM(float health, double entityDamage, double attackSpeed, Item holdItem) {
		return holdItem instanceof ItemSword ? (entityDamage+((ItemSword) holdItem).getAttackDamage())*health : (entityDamage)*health;
	}
}